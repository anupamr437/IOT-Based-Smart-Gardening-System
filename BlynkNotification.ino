...
const int sensorPin = 00; // connect digital output pin D0 of Moisture Sensor to pin D3 of NodeMCU Kit, which connects to GPIO 00 of ESP8266.
int sensorState = 0;
int lastState = 0;
int c;
const int redPin = 4; //connect pin R of RGB LED to D2 of NodeMCU Kit, which connects to GPIO 04 of ESP8266.
const int greenPin = 12; //connect pin G of RGB LED to D6 of NodeMCU Kit, which connects to GPIO 12 of ESP8266
const int bluePin = 14; //connect pin B of RGB LED to D5 of NodeMCU Kit, which connects to GPIO 14 of ESP8266
void setup()
{
